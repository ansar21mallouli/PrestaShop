...
module.exports = {
  createCustomerAddress: function (customerData) {
    scenario('Create a new "Address"', client => {
      ...
      test('should check that the "First name" input is "' + customerData.first_name + '"', () => client.checkCustomerDetail(Addresses.first_name_input, customerData.first_name));
      test('should check that the "Last name" input is "' + customerData.last_name + '"', () => client.checkCustomerDetail(Addresses.last_name_input, customerData.last_name));
