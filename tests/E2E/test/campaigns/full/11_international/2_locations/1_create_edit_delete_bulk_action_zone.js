...
scenario('Create, edit, delete and check "Zone" in the Back Office', () => {
  scenario('Login in the Back Office', client => {
    test('should open the browser', () => client.open());
    test('should log in successfully in the Back Office', () => client.signInBO(AccessPageBO));
  }, 'common_client');

  scenario('Test 1: Create, check zones in the Back Office', () => {
    ...
    scenario('Check results in the Back Office', client => {
      ...
      test('should get number of zones', () => client.getTextInVar(Location.Zone.number_zone_span, "number_zones"));
    }, 'common_client');
    commonLocation.sortZoneCountry(Location.Zone.element_zone_table.replace('%B', 2), 'ID');
    commonLocation.sortZoneCountry(Location.Zone.element_zone_table.replace('%B', 3), 'Zone');
